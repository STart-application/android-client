...
// https://github.com/PRNDcompany/prnd-android-sample
class IndentLeadingMarginSpan(
    ...
    override fun drawLeadingMargin(
        ...
        // 해당줄의 처음 3글자를 가져옴
        val lineStartText =
            runCatching { text.substring(lineStart, lineStart + 3) }.getOrNull() ?: return
    ...
    companion object {
        private val INDENT_DELIMITERS = listOf("·", "ㆍ", "-", "┗", "1.", "2.")
    }
}