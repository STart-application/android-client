...
enum class ApiError(val code: String, val message: String) {
    ...
    ST030("ST030", "ST030: 관리자 권한이 없습니다."),
    ST040("ST040", "ST040: 지원하지 않는 경로입니다."),
    ST041("ST041", "ST041: 찾을 수 없는 리소스입니다."),
    ST050("ST050", "ST050: (로그인) 비밀번호가 일치하지 않습니다."),
    ST051("ST051", "ST051: "),
    ST052("ST052", "ST052: "),
    ST053("ST053", "ST053: 이미 가입된 학번입니다."),
    ST054("ST054", "ST054: (상시사업) 대여 물품의 개수가 유효하지 않습니다."),
    ST055("ST055", "ST055: (상시사업/어드민) ItemNo가 중복됩니다."),
    ST056("ST056", "ST056: "),
    ST057("ST057", "ST057: (로그인/회원가입) 학생증 인증이 되지 않은 회원입니다."),
    ST058("ST058", "ST058: (로그인/회원가입) 탈퇴한 회원입니다."),
    ST059("ST059", "ST059: "),
    ST060("ST060", "ST060: (스탬프) 중복 요청"),
    ST061("ST061", "ST061: (대여사업) 대여가 승인되지 않습니다."),
    ST062("ST062", "ST062: (스탬프) 모든 스탬프를 얻지 않았습니다."),
